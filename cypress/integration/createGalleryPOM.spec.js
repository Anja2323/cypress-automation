...
describe("Create Gallery page", () => {
  ...
  xit(" title with more than 255 chars", () => {
  ...
  xit("description more than 1000 chars", () => {
    createGallery.title.type("klp");
 ...
 it('create gallery with valid data', () =>{
     createGallery.create('hello', 'flower', 'https://staticsensa.mondo.rs/Picture/34702/jpeg/cvet-simbol-ljubavi-vecnosti-novog-zivota-dom-kala_454755673.jpg');
     cy.url().should('not.include', '/create');
 })
});
